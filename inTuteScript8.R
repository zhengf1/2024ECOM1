##---------------------------------------------------------------------------------
############### ECOM20001 Econometrics 1 Tutorial 8
...
# or
setwd("~/Dropbox/01 UoM-Teaching/2024-S2-Ecom1/Week8") # your path should be different 
...
num1=(R2u-R2r)/3
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# denom1 from R.script and solution were incorrect. 
# here we should use 1 - R2u but not 1 - R2r
# Make sure you correct them (download the new version)
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
denom1=(1-R2u)/2989 
 Fstat1=num1/denom1
