##---------------------------------------------------------------------------------
############### ECOM20001 Econometrics 1 Tutorial 10
# Zheng Fan
...
setwd( dirname(rstudioapi::getActiveDocumentContext()$path) ) # based the location of R script
# or  
setwd("~/Dropbox/01 UoM-Teaching/2024-S2-Ecom1/Week10") # your path should be different 
...
newdata1=data.frame(age=28,bachelor=0,female=1,female_age=28,d1992=0)
...
newdata2=data.frame(age=28,bachelor=0,female=0,female_age=0,d1992=0)
